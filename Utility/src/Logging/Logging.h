...
namespace Logging
{
   ...
   enum DateControlCharacters
   {
      ...
      DCC_FULL_WEEKDAY_NAME_ = 'A',                                                  //  %A  // Full weekday name *
      DCC_ABBREVIATED_MONTH_NAME_ = 'b',                                             //  %b  // Abbreviated month name *
      DCC_FULL_MONTH_NAME_ = 'B',                                                    //  %B  // Full month name *
      DCC_DATE_AND_TIME_REPRESENTATION_ = 'c',                                       //  %c  // Date and time representation *
      ...
      DCC_ABBREVIATED_MONTH_NAME = 'h',                                              //  %h  // Abbreviated month name * ( same as %b )
